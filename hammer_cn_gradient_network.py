...
class ActorCritic(nn.Module):
    def __init__(self, state_dim, action_dim, actor_layer, critic_layer, n_agents):
        ...
        for _ in n_agents:
            ...
            self.action_layers.append(nn.Sequential(*layers))
        ...
        self.global_layer = nn.Sequential(*layers)
...
class PPO:
    def __init__(self, state_dim, action_dim, actor_layer, critic_layer, lr, betas, gamma, K_epochs, eps_clip, shared=True):
        ...
        self.policy = ActorCritic(state_dim=state_dim, action_dim=action_dim, actor_layer=actor_layer, critic_layer=critic_layer, n_agents = n_agents).to(device)
